...
- **'Outputs/'** you can find the two h5 files created in this assignment
- **'deep-learning.ipynb'** you can find the initial workbook with my first attempt. 
- **`deep-learning-optimization.ipynb`** contains the second pass to try to improve the model.
- **'Analysis-Report.md'** you can find the final analysis on this assignment

## Sources / References
- Header image: https://www.mouser.com/blog/development-of-deep-learning
- Repo used as reference: 
  * https://github.com/Ivarvani/deep-learning-challenge
